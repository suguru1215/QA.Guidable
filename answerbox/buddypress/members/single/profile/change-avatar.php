...
<?php if ( !(int)bp_get_option( 'bp-disable-avatar-uploads' ) ) : ?>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p id="avatar-upload" class="clearfix">
				<input type="file" name="file" id="file" class="btn btn-default pull-left"  />
				<input type="submit" name="upload" id="upload" class="btn pull-left" value="<?php esc_attr_e( 'Upload Image', 'buddypress' ); ?>" />
			...
			<?php if ( bp_get_user_has_avatar() ) : ?>
				...
				<p><a class="button edit btn btn-default btn-delete-avatar" href="<?php bp_avatar_delete_link(); ?>" title="<?php esc_attr_e( 'Delete Profile Photo', 'buddypress' ); ?>"><?php _e( 'Delete My Profile Photo', 'buddypress' ); ?></a></p>
			<?php endif; ?>
